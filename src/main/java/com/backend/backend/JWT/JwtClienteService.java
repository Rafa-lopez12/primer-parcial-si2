...
public class JwtClienteService {
    ...
    private String getToken(Map<String, String> extraClaims, UserDetails user) {
        // Añadir el email como claim personalizado
        Cliente cliente = clienteRepository.getReferenceById(user.getUsername());
        extraClaims.put("email", user.getUsername());
        extraClaims.put("nombre", cliente.getNombre());
